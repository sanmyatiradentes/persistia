...
- "podcast": roteiro de cerca de ${t.palavras} palavras em diálogo entre ANA e LÉO — uma aula de verdade, não uma chamada: abertura de 2 frases, desenvolvimento do assunto com exemplos, três pausas de recuperação ("pensa aí…"), os erros que a banca explora e um resumo relâmpago no fim. Marque CADA fala começando a linha com "ANA:" ou "LEO:" — exatamente assim, em letras maiúsculas, sem acento no LEO, sem travessão, sem negrito e sem parênteses de narração. Uma fala por linha, alternando as duas vozes. Esses rótulos são o que liga cada fala à voz certa na gravação.
